...
const addNewSheet  = async (values, sheetName, { spreadsheetId, workSheetName }, commentSheetFileLoc = null) => new Promise(async (resolve, reject) => {
            try {
                ...
                const result = await appendData(auth, sheetName, values, spreadsheetId);
